...
import 'email_link_secure_store.dart';
...
class EmailLinkError {
  ...
  Map<EmailLinkErrorType, String> get _messages => {
        ...
        EmailLinkErrorType.isNotSignInWithEmailLink:
            isNotSignInWithEmailLinkMessage,
        EmailLinkErrorType.emailNotSet: submitEmailAgain,
        EmailLinkErrorType.signInFailed: description,
        EmailLinkErrorType.userAlreadySignedIn: userAlreadySignedIn,
      };
