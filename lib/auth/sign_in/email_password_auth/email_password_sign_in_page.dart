...
import 'package:mileo/widgets/form_submit_button.dart';
import 'package:provider/provider.dart';

import 'email_password_login_sign_in_model.dart';
        ...
        children: <Widget>[
          ...
          if (model.formType == EmailPasswordSignInFormType.signIn)
            FlatButton(
              ...
              child: Text(forgotPasswordQuestion),
              onPressed: model.isLoading
                  ? null
                  : () => _updateFormType(
